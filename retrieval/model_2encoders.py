...
from transformers import T5EncoderModel, LlamaModel, AutoTokenizer
...
class TwoEncoderPremiseRetriever(pl.LightningModule):
    def __init__(
        ...
        assert self.context_encoder.embedding_size == self.premise_encoder.embedding_size, "embedding sizes of encoder must be equal"
    ...
    def forward(
        ...
        neg_premise_embs = [
            self.premise_encoder.encode(ids, mask)
