...
class ColBERTDatasetNative(RetrievalDataset):
    def __init__(
        ...
        self.data = list(itertools.chain.from_iterable(self._load_data(path) for path in data_path_list))
...
class ColBERTDataModuleNative(pl.LightningDataModule):
    ...
    def save_datasets(self):
        ...
        for split in ["train", "val"]:
            ...
            ds = ColBERTDataset(self.config, self.corpus, data_path_list, is_train=True)
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage in (None, "fit", "validate"):
            ...
            self.ds_train = ColBERTDataset(self.config, self.corpus, data_path_list, is_train=True)
        ...
        if stage in (None, "fit", "validate"):
            ...
            self.ds_val = ColBERTDataset(self.config, self.corpus, data_path_list, is_train=True)
        ...
        if stage in (None, "fit", "predict"):
            ...
            self.ds_pred = ColBERTDataset(self.config, self.corpus, data_path_list, is_train=False)
