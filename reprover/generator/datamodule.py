...
class MultipleSegmentGeneratorDataset(GeneratorDataset):
    def __init__(
        self,
        data_path: str,
        corpus: Corpus,
        ...
        GeneratorDataset.__init__(
            self, data_path, corpus, keep_marks, preds, max_seq_len, p_drop, normalize_tactics, tokenizer, is_train
        )
